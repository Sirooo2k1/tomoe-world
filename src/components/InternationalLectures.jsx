        ...
        <article className="p-8 md:p-12 text-gray-700 leading-relaxed text-base md:text-lg space-y-6">
          ...
          <section className="mt-10 space-y-4">
            ...
            <p className="indent-4 md:indent-6" dangerouslySetInnerHTML={{
              __html: t(
                '　<a href="https://nishan.jp/profile/" target="_blank" rel="noopener noreferrer" style="color: #c59a53; text-decoration: underline;" onmouseover="this.style.color=\'#a87f3d\'" onmouseout="this.style.color=\'#c59a53\'">にしゃんた</a>の講演では、「<a href="#ask" target="_blank" rel="noopener noreferrer" style="color: #c59a53; text-decoration: underline;" onmouseover="this.style.color=\'#a87f3d\'" onmouseout="this.style.color=\'#c59a53\'">共笑®︎</a>（共に笑う）」の理念を軸に、"ちがい"を楽しみ、学び、成長の糧とする視点をお伝えします。<a href="https://nishan.jp/education/" target="_blank" rel="noopener noreferrer" style="color: #c59a53; text-decoration: underline;" onmouseover="this.style.color=\'#a87f3d\'" onmouseout="this.style.color=\'#c59a53\'">国際理解</a>や<a href="https://nishan.jp/message/" target="_blank" rel="noopener noreferrer" style="color: #c59a53; text-decoration: underline;" onmouseover="this.style.color=\'#a87f3d\'" onmouseout="this.style.color=\'#c59a53\'">多文化共生</a>の大切さを実感し、日常や職場、地域で実践できる知識とスキルを得られる内容です。',
                '　In his talks, <a href="https://nishan.jp/profile/" target="_blank" rel="noopener noreferrer" style="color: #c59a53; text-decoration: underline;" onmouseover="this.style.color=\'#a87f3d\'" onmouseout="this.style.color=\'#c59a53\'">Nishanta</a> uses the <a href="#ask" target="_blank" rel="noopener noreferrer" style="color: #c59a53; text-decoration: underline;" onmouseover="this.style.color=\'#a87f3d\'" onmouseout="this.style.color=\'#c59a53\'">共笑®︎</a> idea of "laughing together" to show how to enjoy, learn from, and grow with differences. You\'ll feel the importance of <a href="https://nishan.jp/education/" target="_blank" rel="noopener noreferrer" style="color: #c59a53; text-decoration: underline;" onmouseover="this.style.color=\'#a87f3d\'" onmouseout="this.style.color=\'#c59a53\'">international understanding</a> and <a href="https://nishan.jp/message/" target="_blank" rel="noopener noreferrer" style="color: #c59a53; text-decoration: underline;" onmouseover="this.style.color=\'#a87f3d\'" onmouseout="this.style.color=\'#c59a53\'">multicultural coexistence</a>, and gain knowledge and skills you can use at home, work, and in your community.'
              )
            }} />
          </section>
          <section className="mt-10 space-y-4">
          ...
          <div className="mt-8 space-y-4">
            ...
            <p className="indent-4 md:indent-6" dangerouslySetInnerHTML={{
              __html: t(
                '「違いを楽しみ、未来を創る」講演を通じて、笑顔と共感に満ちたつながりを広げませんか？講演依頼や詳細なご相談は、<a href="#ask" target="_blank" rel="noopener noreferrer" style="color: #c59a53; text-decoration: underline;" onmouseover="this.style.color=\'#a87f3d\'" onmouseout="this.style.color=\'#c59a53\'">共笑®︎事務局</a>までお気軽にお問い合わせください。共に学び、共に未来を築きましょう！',
                'Would you like to spread connections full of smiles and empathy through a talk on "enjoying differences to create the future"? For lecture requests or detailed consultations, please feel free to contact the <a href="#ask" target="_blank" rel="noopener noreferrer" style="color: #c59a53; text-decoration: underline;" onmouseover="this.style.color=\'#a87f3d\'" onmouseout="this.style.color=\'#c59a53\'">共笑®︎ office</a>. Let\'s learn together and build the future together!'
              )
            }} />
          </div>
          ...
          <section className="mt-10 space-y-3">
            ...
            <p className="indent-4 md:indent-6" dangerouslySetInnerHTML={{
              __html: t(
                '✧Q：講演料の目安は？<br />A：ご相談も承ります。ご依頼やお問い合わせは<a href="#ask" target="_blank" rel="noopener noreferrer" style="color: #c59a53; text-decoration: underline;" onmouseover="this.style.color=\'#a87f3d\'" onmouseout="this.style.color=\'#c59a53\'">「共笑®︎事務局」</a>まで',
                '✧Q: What are typical lecture fees?<br />A: We welcome inquiries. For requests or questions, please contact the <a href="#ask" target="_blank" rel="noopener noreferrer" style="color: #c59a53; text-decoration: underline;" onmouseover="this.style.color=\'#a87f3d\'" onmouseout="this.style.color=\'#c59a53\'">共笑®︎ office</a>.'
              )
            }} />
          </section>
